    ...
    return (
        <div className="bg-gray-800 text-white h-full w-64 shadow-lg">
            ...
            {dtoken && (
                <ul className="flex flex-col p-4 space-y-4">
                    <li>
                        <NavLink to="/doctor-dashboard" className="flex items-center p-2 hover:bg-gray-700 rounded-lg transition">
                            <img src={assets.home_icon} alt="Dashboard" className="w-6 h-6 mr-2" />
                            <p className="font-semibold">DashBoard</p>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/doctor-appointments" className="flex items-center p-2 hover:bg-gray-700 rounded-lg transition">
                            <img src={assets.appointment_icon} alt="Appointments" className="w-6 h-6 mr-2" />
                            <p className="font-semibold">Appointments</p>
                        </NavLink>
                    </li>
                    ...
                    <li>
                        <NavLink to="/doctor-profile" className="flex items-center p-2 hover:bg-gray-700 rounded-lg transition">
                            <img src={assets.people_icon} alt="Doctors List" className="w-6 h-6 mr-2" />
