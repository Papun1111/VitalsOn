...
import './Footer.css'; // Optional: for any additional custom styles
      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-8 lg:space-y-0 lg:space-x-10">
        ...
        <div className="space-y-4 lg:max-w-lg">
          ...
          <p className="text-sm md:text-base text-gray-400">
            ...
            laudantium pariatur? Rem tenetur adipisci accusamus ipsa assumenda 
            aliquid, eum iste possimus magnam quidem ex vel consequatur aut animi iure.
          </p>
        </div>
